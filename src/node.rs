...
pub(crate) trait Direction: Sized + 'static {
  ...
  unsafe fn build_node_param(state: &mut State<Self>, b: &mut libspa::pod::builder::Builder, id: u32, index: u32) -> ParamBuild;
...
// port Latency param
pub(crate) unsafe fn handle_process_latency<D: Direction>(state: &mut State<D>, info: spa_process_latency_info) {
...
unsafe extern "C" fn set_callbacks<D: Direction>(object: *mut c_void, callbacks: *const spa_node_callbacks, data: *mut c_void) -> c_int {
...
unsafe extern "C" fn enum_params<D: Direction>(object: *mut c_void, seq: c_int, id: u32, start: u32, max: u32, filter: *const spa_pod) -> c_int {
...
unsafe extern "C" fn set_param<D: Direction>(object: *mut c_void, id: u32, _flags: u32, param: *const spa_pod) -> c_int {
...
unsafe extern "C" fn on_timeout<D: Direction>(source: *mut spa_source) {
  ...
  let state = (*source).data.cast::<State<D>>().as_mut()
...
unsafe extern "C" fn set_io<D: Direction>(object: *mut c_void, id: u32, data: *mut c_void, size: usize) -> c_int {
...
unsafe extern "C" fn send_command<D: Direction>(object: *mut c_void, command: *const spa_command) -> c_int {
  ...
  match (body.type_, body.id) {
    ...
    (cmd_type, cmd_id) => {
      crate::warn!(state.log, "{}unknown command: {}, {}", D::CMD_WARN_PREFIX, cmd_type, cmd_id);
      -libc::ENOTSUP
    }
  }
}
...
unsafe extern "C" fn port_use_buffers<D: Direction>(object: *mut c_void, direction: spa_direction, port_id: u32, flags: u32, buffers: *mut *mut spa_buffer, n_buffers: u32) -> c_int {
...
unsafe extern "C" fn port_set_io<D: Direction>(object: *mut c_void, direction: spa_direction, port_id: u32, id: u32, data: *mut c_void, _size: usize) -> c_int {
...
unsafe extern "C" fn get_interface<D: Direction>(handle: *mut spa_handle, type_: *const c_char, interface: *mut *mut c_void) -> c_int {
  let state = handle.cast::<State<D>>().as_mut()
...
pub(crate) unsafe extern "C" fn get_size<D: Direction>(_factory: *const spa_handle_factory, _params: *const spa_dict) -> usize {
...
pub(crate) unsafe extern "C" fn enum_interface_info(_factory: *const spa_handle_factory, info: *mut *const spa_interface_info, index: *mut u32) -> c_int {
  assert!(!info .is_null());
